...
export default function AddToCartButton({ product }) {
    ...
    const handleCartDecrease = () => {
        ...
        if (cartItem.quantity === 1) {
            ...
            showCartToast(`${product.title} removed from cart`, "remove");
        } else {
    ...
    // Function to add or increase the quantity of an item in the cart, with toastify message shown only when the item is first added
